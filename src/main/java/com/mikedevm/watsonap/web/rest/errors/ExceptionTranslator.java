package com.mikedevm.watsonap.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.mikedevm.watsonap.service.EmailAlreadyUsedException ||
            ex instanceof com.mikedevm.watsonap.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.mikedevm.watsonap.service.InvalidPasswordException
